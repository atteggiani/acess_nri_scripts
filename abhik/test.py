...
veg_compare_file="/g/data/tm70/dm5220/scripts/abhik/ancil/veg_compare"
veg_file="/g/data/tm70/dm5220/scripts/abhik/ancil/VEGINIT"
veg_compare=mule.AncilFile.from_file(veg_compare_file)
...
for f in new_veg.fields:
    # Set 5 Pseudo-levels for functional types
    if f.lbuser4 != 213:
